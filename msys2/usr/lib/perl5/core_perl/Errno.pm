...
"x86_64-msys-thread-multi-3.1.6-340.x86_64" or
	die "Errno architecture (x86_64-msys-thread-multi-3.1.6-340.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
