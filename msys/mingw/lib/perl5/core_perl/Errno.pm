...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAECANCELLED WSAENETRESET WSAENETUNREACH WSAEDQUOT WSAELOOP
	WSAENOTSOCK WSAECONNREFUSED WSAETOOMANYREFS WSAEALREADY
	WSAEINVALIDPROCTABLE WSAEINVAL WSAENOTCONN WSAESOCKTNOSUPPORT
	WSAECONNABORTED WSAEHOSTUNREACH WSAEADDRNOTAVAIL WSAENOBUFS
	WSAENETDOWN WSAEINPROGRESS WSAESHUTDOWN WSAEBADF WSAEUSERS WSAEMFILE
	WSAEFAULT WSAEISCONN WSAENAMETOOLONG WSAEHOSTDOWN WSAEADDRINUSE
	WSAEOPNOTSUPP WSAEMSGSIZE WSAEREMOTE WSAEPROCLIM WSAENOTEMPTY
	WSAEPROTONOSUPPORT WSAEPFNOSUPPORT WSAEWOULDBLOCK WSAEACCES
	WSAEINVALIDPROVIDER WSAESTALE WSAEPROTOTYPE WSAEAFNOSUPPORT WSAEINTR
	WSAENOPROTOOPT WSAEPROVIDERFAILEDINIT WSAEDESTADDRREQ WSAEDISCON
	WSAETIMEDOUT WSAENOMORE WSAECONNRESET WSAEREFUSED
    )],
);
