...
"x86_64\-cygwin\-thread\-multi-3\.6\.4\-23a25d49\.x86_64" or
	die "Errno architecture (x86_64\-cygwin\-thread\-multi-3\.6\.4\-23a25d49\.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
